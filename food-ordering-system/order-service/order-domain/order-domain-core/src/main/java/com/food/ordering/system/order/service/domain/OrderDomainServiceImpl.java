...
public class OrderDomainServiceImpl implements OrderDomainService {
    ...
    // se puede mejorar utilizando una estructura de datos adicional para productos
    // como el hashmap para reducir el tiempo (debido a los dos bucles)
    // Abajo el método solución
